...
DICCIONARIO_TRATAMIENTOS = {
    ...
    "PODREDUMBRE APICAL": "Regularizar las pautas de riego evitando fluctuaciones drásticas. Corregir la deficiencia de Calcio (Ca) en la planta mediante pulverizaciones foliares de nitrato cálcico o quelatos.",
    ...
    "COCHINILLA": "Limpieza manual con alcohol de quemar y algodón en plantas pequeñas. En ataques generalizados, aplicar aceite de verano combinado con un insecticida sistémico autorizado.",
    ...
    "SUELO ALCALINO": "Aplicar quelatos de hierro (Fe) directamente al riego para corregir la clorosis férrica. Acidificar el sustrato aportando turba rubia, azufre elemental o agua de riego corregida.",
...
if not diagnosticos_detectados:
    ...
    for prob, clave in diagnosticos_detectados.items():
        st.markdown(f"### 🚨 {prob}")
        sol = DICCIONARIO_TRATAMIENTOS.get(clave, "Se recomienda consulta con el técnico agrícola.")
        st.write(f"🛠️ **Tratamiento recomendado:** {sol}")
